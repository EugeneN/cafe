...
(function() {
  var EVENT_CAFE_DONE, EXIT_HELP, EXIT_OTHER_ERROR, EXIT_SIGINT, LOG_PREFIX, PR_SET_PDEATHSIG, SIGINT, SIGTERM, START_TIME, apply1, apply2, cafe_factory, draw_logo, events, exit_cb, fb, green, growl, is_array, logger, murmur, pessimist, red, say, scream, shout, whisper, yellow, _base, _ref,
    __slice = [].slice,
    _this = this;
  ...
  _ref = require('../../defs'), EXIT_HELP = _ref.EXIT_HELP, PR_SET_PDEATHSIG = _ref.PR_SET_PDEATHSIG, EXIT_SIGINT = _ref.EXIT_SIGINT, EXIT_SIGINT = _ref.EXIT_SIGINT, SIGTERM = _ref.SIGTERM, SIGINT = _ref.SIGINT, EXIT_OTHER_ERROR = _ref.EXIT_OTHER_ERROR, EVENT_CAFE_DONE = _ref.EVENT_CAFE_DONE;
