...
(function() {
  var BUILD_DEPS_FN, CB_SUCCESS, FILE_ENCODING, RECIPE, RECIPE_API_LEVEL, RECIPE_EXT, TMP_BUILD_DIR_SUFFIX, add, async, build, build_bundle, build_bundles, check_ctx, compose, extend, filter_duplicates, fs, get_ctx_recipe, get_opt, get_recipe, get_tmp_build_dir, has_ext, help, is_dir, is_file, make_target, map, map_sort_bundles, partial, path, process_realms, read_json_file, resolve_deps, run_target, say, scream, shout, show_bundles, show_realms, toposort, whisper, write_build_deps_file, _ref, _ref1, _ref2, _ref3, _ref4, _ref5,
