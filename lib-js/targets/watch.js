...
(function() {
  var COFFEE_PATTERN, filter_dict, fs, good_watch_seq, help, is_debug_context, is_dir, make_target, path, say, scream, shout, watch, watcher, whisper, _ref, _ref1;
  ...
  good_watch_seq = function(ctx) {
    var seq;
    seq = Object.keys(ctx.full_args).filter(function(k) {
  ...
  watch = function(ctx, cb) {
    ...
    return ctx.fb.say("Press `Ctrl-c` to stop watching.");
  };
