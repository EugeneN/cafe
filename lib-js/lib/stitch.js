...
(function() {
  var Module, Stitch, compilers, flatten, fs, modulerize, npath, say, scream, shout, whisper, _ref;
  ...
  _ref = (require('../lib/logger'))("Stitch>"), say = _ref.say, shout = _ref.shout, scream = _ref.scream, whisper = _ref.whisper;
  ...
  Stitch = (function() {
    ...
    Stitch.prototype.walk = function(path, parent, result) {
      var child, module, stat, _i, _len, _ref1;
      if (parent == null) {
        parent = path;
      }
      if (result == null) {
