...
(function() {
  var SEP, SUB_CAFE, THRESHOLD_INTERVAL, THRESHOLD_QUEUE_ACTIVE, THRESHOLD_QUEUE_EMPTY, WATCH_FN_PATTERN, async, build, build_cmd, filter_dict, fork, fs, is_array, is_debug_context, maybe_build, path, path_matches, say, scream, shout, spawn, watch, whisper, _get_build_dir, _ref, _ref1, _ref2, _ref3;
  ...
  module.exports = {
    watch: function(ctx) {
      ...
      modules.map(function(module_root) {
        ...
        change_handler = function(file, curr, prev) {
          var fn;
