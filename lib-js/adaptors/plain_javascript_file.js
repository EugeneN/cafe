...
(function() {
  var CB_SUCCESS, JS_EXT, and_, async, fs, get_mtime, get_paths, has_ext, is_file, path, say, scream, shout, whisper, _ref, _ref1, _ref2;
  ...
  _ref2 = require('../defs'), JS_EXT = _ref2.JS_EXT, CB_SUCCESS = _ref2.CB_SUCCESS;
  ...
  module.exports = (function() {
    ...
    match = function(ctx) {
      ...
      return (is_file(source_fn)) && (has_ext(source_fn, JS_EXT));
    };
    match.async = function(ctx, cb) {
      ...
      return async.parallel([
        (function(is_file_cb) {
          ...
          return has_ext.async(source_fn, JS_EXT, is_file_cb);
        })
      ], function(err, res) {
