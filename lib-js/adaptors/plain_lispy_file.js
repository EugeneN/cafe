...
(function() {
  var CB_SUCCESS, FILE_ENCODING, JS_EXT, LISPY_BIN, LISPY_EXT, TMP_BUILD_DIR_SUFFIX, and_, async, cs, exec, fs, get_mtime, get_paths, get_target_fn, has_ext, is_file, newer, path, say, scream, shout, whisper, _ref, _ref1, _ref2;
  ...
  _ref1 = (require('../lib/logger'))("Adaptor/lispy>"), say = _ref1.say, shout = _ref1.shout, scream = _ref1.scream, whisper = _ref1.whisper;

  exec = require('child_process').exec;

  async = require('async');

  _ref2 = require('../defs'), FILE_ENCODING = _ref2.FILE_ENCODING, TMP_BUILD_DIR_SUFFIX = _ref2.TMP_BUILD_DIR_SUFFIX, LISPY_EXT = _ref2.LISPY_EXT, JS_EXT = _ref2.JS_EXT, LISPY_BIN = _ref2.LISPY_BIN, CB_SUCCESS = _ref2.CB_SUCCESS;

  get_target_fn = function(app_root, module_name) {
    return path.resolve(app_root, TMP_BUILD_DIR_SUFFIX, (module_name.replace(new RegExp("" + LISPY_EXT + "$"), '')) + JS_EXT);
  };
  ...
  module.exports = (function() {
    ...
    match = function(ctx) {
      ...
      return (is_file(source_fn)) && (has_ext(source_fn, LISPY_EXT));
    };
    match.async = function(ctx, cb) {
      ...
      return async.parallel([
        (function(is_file_cb) {
          ...
          return has_ext.async(source_fn, LISPY_EXT, is_file_cb);
        })
      ], function(err, res) {
    ...
    make_adaptor = function(ctx) {
      ...
      harvest = function(cb) {
        ...
        if (ctx.own_args.f || (newer(source_fn, target_fn))) {
          return exec("" + LISPY_BIN + " " + source_fn + " " + target_fn, function(err, stdout, stderr) {
            if (err) {
