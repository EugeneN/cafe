...
(function() {
  var CAFE_TARGET_FN_ENV_NAME, CAFE_TMP_BUILD_ROOT_ENV_NAME, CAKEFILE, CAKE_BIN, CAKE_TARGET, CB_SUCCESS, FILE_ENCODING, JS_EXT, NODE_PATH, TMP_BUILD_DIR_SUFFIX, and_, async, cs, exec, extend, fs, get_mtime, get_paths, get_target_fn, has_ext, is_dir, is_file, maybe_build, newer, newest, path, say, scream, shout, walk, whisper, _ref, _ref1, _ref2;
