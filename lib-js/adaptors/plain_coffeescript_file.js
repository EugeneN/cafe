...
(function() {
  var CB_SUCCESS, CS_EXT, FILE_ENCODING, JS_EXT, TMP_BUILD_DIR_SUFFIX, and_, async, cs, fs, get_mtime, get_paths, get_result_filename, get_target_fn, has_ext, is_file, newer, path, say, scream, shout, whisper, _ref, _ref1, _ref2;
  ...
  _ref2 = require('../defs'), FILE_ENCODING = _ref2.FILE_ENCODING, TMP_BUILD_DIR_SUFFIX = _ref2.TMP_BUILD_DIR_SUFFIX, CS_EXT = _ref2.CS_EXT, JS_EXT = _ref2.JS_EXT, CB_SUCCESS = _ref2.CB_SUCCESS;
  ...
  get_paths = function(ctx) {
    ...
    src = ctx.own_args.src || (path.resolve(app_root, module_name));
  ...
  module.exports = (function() {
    ...
    match = function(ctx) {
      ...
      return (is_file(source_fn)) && (has_ext(source_fn, CS_EXT));
    };
    match.async = function(ctx, cb) {
      ...
      return async.parallel([
        (function(is_file_cb) {
          ...
          return has_ext.async(source_fn, CS_EXT, is_file_cb);
        })
      ], function(err, res) {
