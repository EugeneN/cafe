...
(function() {
  var CB_SUCCESS, CS_ADAPTOR_PATH_SUFFIX, CS_RUN_CONCURRENT, Compiler, SLUG_FN, TMP_BUILD_DIR_SUFFIX, add, and_, async, build_cs_mod, build_factory, extend, fn_without_ext, fs, get_mtime, get_paths, is_debug_context, is_dir, is_file, maybe_build, newest, or_, path, read_json_file, toArray, walk, _ref, _ref1;
  ...
  _ref1 = require('../../defs'), SLUG_FN = _ref1.SLUG_FN, TMP_BUILD_DIR_SUFFIX = _ref1.TMP_BUILD_DIR_SUFFIX, CS_ADAPTOR_PATH_SUFFIX = _ref1.CS_ADAPTOR_PATH_SUFFIX, CB_SUCCESS = _ref1.CB_SUCCESS, CS_RUN_CONCURRENT = _ref1.CS_RUN_CONCURRENT;
  ...
  build_factory = function(mod_src, ctx) {
    var compiler_args, emitter, js_path, slug, slug_path, target_file, _ref2;
    _ref2 = get_paths(ctx), slug_path = _ref2.slug_path, js_path = _ref2.js_path;
