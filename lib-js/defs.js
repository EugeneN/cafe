...
(function() {
  var ADAPTORS_LIB, ADAPTORS_PATH, CAFE_TARBALL, CONFIG_FILE, REPO_URL, SUB_CAFE, TARGET_PATH, TMP_BUILD_DIR_SUFFIX, VERSION, VERSION_FILE, VERSION_FILE_PATH, default_config, extend, fs, path, read_json_file, user_config;
